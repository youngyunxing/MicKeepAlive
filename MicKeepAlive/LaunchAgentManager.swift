...
final class LaunchAgentManager {
    ...
    private let logger = Logger(subsystem: "com.example.MicKeepAlive", category: "LaunchAgent")
    private let label = "com.example.MicKeepAlive"
    ...
    private var executablePath: String {
        Bundle.main.bundleURL.appendingPathComponent("Contents/MacOS/MicKeepAlive").path
    }
